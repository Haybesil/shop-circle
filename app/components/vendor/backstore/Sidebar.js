...
export default function Sidebar() {
  return (
    ...
    <nav className=''>
      <div className='bg-blue-600 dark:bg-gray-600 w-60 h-screen text-blue-50 p-3 fixed left-0 top-0 shadow-md overflow-y-auto mb-3'>
        <div>
          <Link href="#" className=''>
 ...
 */}
        ...
        <div className="md:flex">
          <ul className="flex-column space-y space-y-4 text-sm font-medium ml-5 md:me-4 mb-4 md:mb-0">
            ...
            <li>
              <Link href="/vendor/dashboard/orders" className="inline-flex items-center px-4 py-3 text-white bg-blue-700 rounded-lg active w-full " aria-current="page">
            ...
            <li>
              <Link href="/vendor/dashboard/store" className="inline-flex items-center px-4 py-3 text-white bg-blue-700 rounded-lg active w-full " aria-current="page">
            ...
            <li>
              <Link href="#" className="inline-flex items-center px-4 py-3 rounded-lg hover:text-gray-900 bg-blue-700 hover:bg-gray-100 w-full  dark:hover:bg-gray-700 dark:hover:text-white">
                <svg className="w-4 h-4 me-2 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
